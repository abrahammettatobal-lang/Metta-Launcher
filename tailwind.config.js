  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        line: {
          subtle: "rgba(244, 234, 220, 0.04)",
          DEFAULT: "rgba(244, 234, 220, 0.07)",
          strong: "rgba(244, 234, 220, 0.12)",
          gold: "rgba(201, 162, 39, 0.22)",
        },
        gold: {
          50: "#fbf3d8",
          100: "#f6e6a7",
